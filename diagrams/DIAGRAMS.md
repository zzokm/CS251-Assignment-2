...
3. **Controller Layer (Application Logic)**
   ...
   * **Examples of controllers:** Expense Controller (Add / Edit / Delete), Budget Controller, Cycle/Management Controller
...
#### 1. Set Initial Budget Cycle (US #1)
This matches the SRS requirement for setting the 30-day allowance.
```mermaid
sequenceDiagram
    actor Student
    participant SetupUI
...
### Tools
- `https://www.plantuml.com/` (Class, State, and Sequence diagrams)
